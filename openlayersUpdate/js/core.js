...
function updateResults( anomalyRequest ){	
	...
	document.getElementById("outputResults").innerHTML =
		...
		+ "coordinates bottom-right: " + boxCoordinates[1]["latitude"] + ", " + boxCoordinates[1]["longitude"] 
		+ "</p>";
...
// lots of things might be screwed up here!
		locationArray[0]["longitude"] = (coordinates[0][1])/100000;
		locationArray[0]["latitude"] = (coordinates[0][0])/100000;
		locationArray[1]["longitude"] = (coordinates[1][1])/100000;
		locationArray[1]["latitude"] = (coordinates[1][0])/100000;;
